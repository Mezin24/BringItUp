...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var mainSlider = new _modules_slider_mainSlider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  mainSlider.render();
  ...
  showupSlider.init();
  var modulesSlider = new _modules_slider_miniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    ...
    value: function bindTriggers() {
      this.triggers.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var msgEl = btn.closest('.module__info-show ').nextElementSibling;
...
/*#__PURE__*/
function () {
  function Difference(container, item) {
    ...
    value: function bindTriggers() {
      ...
      this.plus.addEventListener('click', function () {
        if (_this.counter < _this.items.length - 2) {
          ...
          _this.items[_this.counter].classList.add('animate__animated', 'animate__fadeIn');
          ...
          _this.items[_this.items.length - 1].classList.add('animate__animated', 'animate__fadeOut');
    ...
    value: function bindTriggers() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          statusMessage.text = _this.message.loading;
          ...
          new _services_requests__WEBPACK_IMPORTED_MODULE_6__["default"](_this.path).postData(formData).then(function (res) {
...
/*#__PURE__*/
function () {
  function PlayVideo(triggerBtn, overlay) {
  ...
  _createClass(PlayVideo, [{
    ...
    value: function bindTrigger() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          btn.closest('.module__video-item').setAttribute('data-disabled', 'false');
        ...
        btn.addEventListener('click', function () {
          if (btn.closest('.showup__video') || btn.closest('.module__video-item').getAttribute('data-disabled') === 'true') {
            ...
            if (_this.overlay.querySelector('iframe#frame')) {
    ...
    value: function onPlayerStateChange(state) {
      try {
        if (state.data === 0) {
          ...
          var sibilingEl = this.activeBtn.closest('.module__video-item').nextElementSibling;

          if (sibilingEl.querySelector('.play__text').classList.contains('attention')) {
        ...
        try {
          ...
          if (n === 3) {
            ...
            setTimeout(function () {
              ...
              _this.hanson.classList.add('animate__slideInUp');
            }, 3000);
          } else {
...
function (_Slider) {
  ...
  function MiniSlider(container, btns, prev, next, autoplay, activeClass, animate) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, btns, prev, next, autoplay, activeClass, animate));
  }

  _createClass(MiniSlider, [{
    key: "decoreateSlide",
    value: function decoreateSlide() {
      var _this = this;
    ...
    value: function bindTriggers() {
      ...
      this.prev.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (_toConsumableArray(_this2.slides).some(function (item) {
    ...
    value: function nextSlide() {
      if (_toConsumableArray(this.slides).some(function (item) {
        return item.tagName === 'BUTTON';
      })) {
        this.container.insertBefore(this.slides[0], this.slides[this.slides.length - 3]);
      } else {
    ...
    value: function init() {
      ...
      try {
        ...
        [].concat(_toConsumableArray(this.prev), _toConsumableArray(this.next)).forEach(function (btn) {
